...
- [Live Demo Link](https://react-calculator-and-quotes.onrender.com/)
...
https://github.com/badger-99/math-magicians.git
...
Use this app to make calculations or to learn new math quotes.
...
You can deploy this project through the dev server. To initiate it, run `npm build run` in your cli and the project will open a dev server at http://localhost:3000/
...
Feel free to check the [issues page](https://github.com/badger-99/math-magicians/issues).
